...
namespace CapaNegocio
{
    public class CN_Carrito
    {
        ...
        public bool ExisteCarrito(int idcliente, int idproducto)//CREAR
        {
            return objCapaDato.ExisteCarrito(idcliente, idproducto);
        }

        public bool OperacionCarrito(int idcliente, int idproducto, bool sumar, out string Mensaje)//CREAR
        {
